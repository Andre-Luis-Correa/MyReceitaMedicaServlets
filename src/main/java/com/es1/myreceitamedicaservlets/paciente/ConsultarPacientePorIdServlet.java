...
@WebServlet("/paciente/consultar/id")
public class ConsultarPacientePorIdServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        try {
            ...
            Paciente paciente = ucPacienteServicos.consultarPacientePorId(id);
